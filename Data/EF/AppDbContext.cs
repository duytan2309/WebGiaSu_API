...
namespace Lib.Data.EF
{
    ...
    AppUserClaims
        ...
        public
    DbSet<AppRoleClaim> AppRoleClaims
        { get; set; }
        ...
        public DbSet<AnnouncementUser>
    AnnouncementUsers
        { set; get; }

        public DbSet<Bill> Bills { set; get; }

        public DbSet<BillDetail>
    BillDetails
        { set; get; }
        ...
        public
    DbSet<Courses_Categories> ProductCategories
        { set; get; }
    ...
    DbSet<WholePrice> WholePrices
        ...
        public
    DbSet<AdvertistmentPosition> AdvertistmentPositions
        { get; set; }

        public DbSet<BlogCategory>
    BlogCategories
        { get; set; }
    ...
    FAQs
        ...
        public DbSet<QuestionCategories>
    QuestionCategories
        { set; get; }
        ...
        public DbSet<RecruitmentImages>
    RecruitmentImages
        { set; get; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder /*MySqlConnectionStringBuilder*/ optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer("Server=tcp:servertan.database.windows.net,1433;Initial Catalog=PpwebCore;Persist Security Info=False;User ID=tanit2309;Password=Tan@23091995;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            //optionsBuilder.UseSqlServer("Data Source=43.255.152.25;Database=noithat_database;Integrated Security=False;User ID=noithat_thanhvuong;Password=noithat_database@123;Connect Timeout=60;Encrypt=False;Packet Size=4096");
        }
