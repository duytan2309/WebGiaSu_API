...
namespace Lib.Data.Entities
{
    ...
    public class PolicyCategories : DomainEntity<int>
    {
        ...
        public PolicyCategories(string name, string description, int? parentId, int? homeOrder,
        ...
        public virtual ICollection<Policies> Policies { set; get; }
    }
}